      ...
      <div className="space-y-6 pb-20">
         ...
         <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border-light pb-6">
            ...
            <div className="flex items-center flex-wrap gap-3">
               ...
               <button onClick={() => navigate('/admin/products/new')} className="px-4 sm:px-4 sm:px-6 py-3 bg-charcoal text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-premium-gold hover:text-charcoal transition-all flex items-center gap-2 shadow-lg shadow-charcoal/10">
         ...
         <div className="flex flex-col lg:flex-row items-center gap-4 bg-white p-4 rounded-3xl border border-border-light shadow-sm">
            ...
            <div className="flex-1 lg:flex-none flex items-center gap-3 bg-light-bg px-4 sm:px-4 sm:px-6 py-3.5 rounded-2xl border border-transparent hover:border-premium-gold/20 transition-all cursor-pointer">
                        ...
                        <table className=" ">
                           <thead>
                              <tr className="bg-light-bg/50 border-b border-border-light">
                                 ...
                                 <th className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 text-[10px] font-black text-text-muted uppercase tracking-widest text-center">Global Status</th>
                                 <th className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 text-[10px] font-black text-text-muted uppercase tracking-widest text-right">Market Price</th>
                                 <th className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 text-[10px] font-black text-text-muted uppercase tracking-widest text-right">Sync</th>
                              </tr>
                           </thead>
               ...
               <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                  ...
                  <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="relative bg-white w-full admin-modal-container max-w-lg rounded-[3.5rem] shadow-2xl p-12 border border-border-light overflow-hidden">
                     ...
                     <div className="space-y-8">
                        <div className="bg-light-bg/50 p-4 sm:p-4 sm:p-6 rounded-3xl border border-border-light/50 flex items-center justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                           <div className="space-y-2">
                              ...
                              <select className="w-full bg-light-bg border-none rounded-2xl px-4 sm:px-4 sm:px-6 py-4 font-black text-sm" value={adjustment.type} onChange={e => setAdjustment({ ...adjustment, type: e.target.value })}>
                           ...
                           <div className="space-y-2">
                              ...
                              <input type="number" className="w-full bg-light-bg border-none rounded-2xl px-4 sm:px-4 sm:px-6 py-4 font-black text-xl" value={adjustment.quantity} onChange={e => setAdjustment({ ...adjustment, quantity: Number(e.target.value) })} />
                           </div>
                        </div>
                        ...
                        <div className="space-y-2">
                           ...
                           <input className="w-full bg-light-bg border-none rounded-2xl px-4 sm:px-4 sm:px-6 py-4 font-bold text-sm" placeholder="e.g. Size exchange for Bill #1234" value={adjustment.reason} onChange={e => setAdjustment({ ...adjustment, reason: e.target.value })} />
                        </div>
                     </div>
                  ...
                  <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="relative bg-white w-full admin-modal-container max-w-2xl rounded-[3.5rem] shadow-2xl p-12 border border-border-light max-h-[80vh] flex flex-col">
                     ...
                     <div className="flex-1 overflow-y-auto pr-4 custom-scrollbar space-y-6">
                        {isLoadingHistory ? (
                           ...
                           <div key={i} className="p-4 sm:p-4 sm:p-6 bg-light-bg/30 rounded-3xl border border-border-light/50 flex items-center justify-between group hover:border-premium-gold transition-all">
                              <div className="flex items-center flex-wrap gap-4">
         ...
         <AnimatePresence>
            {deleteProductConfirm && (
               <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                  ...
                  <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="relative bg-white w-full admin-modal-container max-w-sm rounded-[2.5rem] shadow-2xl border border-border-light p-5 md:p-10 text-center">
