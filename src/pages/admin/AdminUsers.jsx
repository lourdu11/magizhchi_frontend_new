    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-border-light overflow-hidden shadow-sm">
        <div className="overflow-x-auto">
          <table className="w-full text-left whitespace-nowrap">
            ...
            <tbody className="divide-y divide-border-light">
              {isLoading && <tr><td colSpan="7" className="px-4 sm:px-4 sm:px-6 py-12 text-center"><Loader2 className="animate-spin inline-block text-premium-gold" /></td></tr>}
              {!isLoading && users?.length === 0 && <tr><td colSpan="7" className="px-4 sm:px-4 sm:px-6 py-12 text-center text-text-muted">No customers found.</td></tr>}
              {users?.map(user => (
        ...
        {pagination && pagination.pages > 1 && (
          <div className="px-4 sm:px-4 sm:px-6 py-4 border-t border-border-light flex items-center justify-between gap-4 bg-light-bg/30">
