...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-dvh bg-[#F8F9FA] flex items-center justify-center p-4 sm:p-4 sm:p-6 relative overflow-hidden font-sans">
      ...
      >
        ...
        <div className="bg-white border border-[#DADCE0] p-4 md:p-4 md:p-8 md:p-5 md:p-10 rounded-[2.5rem] shadow-[0_20px_60px_rgba(32,33,36,0.08)] relative overflow-hidden">
