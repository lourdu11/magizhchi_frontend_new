...
export default function AdminCoupons() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showAdd && (
        <div className="bg-white p-4 sm:p-4 sm:p-6 rounded-xl border border-border-light shadow-sm">
        ...
        <table className="w-full min-w-[700px] text-left border-collapse">
          <thead>
            <tr className="bg-light-bg border-b border-border-light">
              ...
              <th className="px-4 sm:px-4 sm:px-6 py-4 text-xs font-bold text-text-muted uppercase">Discount</th>
              <th className="px-4 sm:px-4 sm:px-6 py-4 text-xs font-bold text-text-muted uppercase">Usage</th>
              <th className="px-4 sm:px-4 sm:px-6 py-4 text-xs font-bold text-text-muted uppercase">Expires</th>
              <th className="px-4 sm:px-4 sm:px-6 py-4 text-xs font-bold text-text-muted uppercase text-right">Actions</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-border-light">
            {isLoading && (
              <tr><td colSpan="5" className="px-4 sm:px-4 sm:px-6 py-10 text-center"><Loader2 className="animate-spin inline-block mr-2" /> Loading...</td></tr>
            )}
            {coupons?.length === 0 && (
              <tr><td colSpan="5" className="px-4 sm:px-4 sm:px-6 py-10 text-center text-text-muted">No coupons found. Create your first one!</td></tr>
            )}
            {coupons?.map(coupon => (
