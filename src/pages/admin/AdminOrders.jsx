...
function OrderDetailsModal({ order, onClose, onUpdateStatus, onPrint, isUpdating, onResendWhatsApp }) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
      ...
      >
        {/* Header */}
        <div className="px-8 py-6 border-b border-border-light flex items-center justify-between bg-white sticky top-0 z-10">
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-8">
              {/* Customer Info */}
              <div className="bg-light-bg/20 rounded-3xl p-6 border border-border-light space-y-6">
                <div>
              ...
              {/* Pricing Breakdown */}
              <div className="bg-charcoal text-white rounded-3xl p-8 shadow-xl shadow-charcoal/20 relative overflow-hidden group">
