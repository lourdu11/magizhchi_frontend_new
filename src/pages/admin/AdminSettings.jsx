    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center font-sans p-4">
        ...
        <motion.div
          ...
          className="w-full max-w-md bg-white rounded-[2.5rem] border border-border-light shadow-2xl p-4 md:p-4 md:p-8 text-center space-y-6"
        >
          ...
          <form onSubmit={handleVerifyKey} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-charcoal text-white hover:bg-premium-gold hover:text-charcoal px-4 md:px-4 md:px-8 py-4 rounded-2xl font-black text-xs tracking-widest transition-all shadow-xl shadow-charcoal/10 flex items-center justify-center gap-2"
            >
              {isVerifying ? (
                <>
  ...
  return (
    <div className="space-y-8 font-sans pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {activeTab !== 'profile' && (
          <button 
            ...
            className={`px-4 md:px-4 md:px-8 py-4 rounded-2xl font-black text-sm tracking-widest shadow-2xl transition-all flex items-center gap-3 ${isDirty ? 'bg-amber-500 text-white hover:bg-amber-600 shadow-amber-200' : 'bg-charcoal text-white hover:bg-premium-gold shadow-charcoal/20'}`}
          >
      ...
      <div className="grid lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-2">
          {[
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 sm:px-4 sm:px-6 py-4 rounded-2xl font-bold text-sm transition-all ${activeTab === tab.id ? 'bg-premium-gold text-charcoal shadow-lg shadow-premium-gold/20' : 'bg-white text-text-muted hover:bg-light-bg'}`}
            >
              <tab.icon size={20} />
              {tab.label}
            </button>
        ...
        {/* Content Area */}
        <div className="lg:col-span-3 bg-white rounded-[2.5rem] border border-border-light p-4 md:p-4 md:p-8 shadow-sm overflow-hidden">
          <AnimatePresence mode="wait">
                  ...
                  <form onSubmit={handleProfileSubmit} className="grid md:grid-cols-2 gap-6 p-1">
                    ...
                    <div className="md:col-span-2 pt-2">
                      <button 
                        ...
                        className="bg-charcoal text-white px-4 md:px-4 md:px-8 py-4 rounded-xl font-black text-xs tracking-widest hover:bg-premium-gold transition-all flex items-center gap-2"
                      >
            ...
            {activeTab === 'payment' && (
              <motion.div key="payment" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} className="space-y-8">
                ...
                <div className="p-4 sm:p-4 sm:p-6 bg-blue-50/50 rounded-[2rem] border border-blue-100">
                ...
                {/* COD Switch */}
                <div className="p-4 sm:p-4 sm:p-6 bg-gold-soft/30 rounded-[2rem] border border-premium-gold/10">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center flex-wrap gap-4">
                      <button 
                        type="button"
              ...
              <motion.div key="notifications" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} className="space-y-10">
                ...
                <div className="space-y-6">
                   ...
                   <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="mt-8 p-4 sm:p-4 sm:p-6 bg-light-bg/40 rounded-[2rem] border border-border-light space-y-6">
                     ...
                     <div className="max-w-md">
                       ...
                       <div className="flex flex-col gap-2">
                         <button 
                           ...
                           className={`mt-4 px-4 sm:px-4 sm:px-6 py-2 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all border ${isEmailDirty ? 'bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed opacity-50' : 'bg-blue-50 text-blue-600 border-blue-100 hover:bg-blue-100'}`} data-test="order-btn"
                         >
                  ...
                  <motion.div key="maintenance" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} className="space-y-8">
                    ...
                    <div className="space-y-4 mb-8">
                      ...
                      {expiredBackups.length > 0 && (
                        <div className="p-4 sm:p-4 sm:p-6 bg-gray-50/50 rounded-[2rem] border border-gray-100">
                          <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="p-4 sm:p-4 sm:p-6 bg-red-50 rounded-[2rem] border border-red-100 mt-6">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <button
                          ...
                          className="bg-red-600 text-white hover:bg-red-700 px-4 md:px-4 md:px-8 py-4 rounded-2xl font-black text-xs tracking-widest shadow-lg shadow-red-200 transition-all flex items-center justify-center gap-2"
                        >
        ...
        {showResetModal && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-lg bg-white rounded-[2.5rem] border border-red-100 shadow-3xl overflow-hidden p-4 md:p-4 md:p-8 z-10 space-y-6"
            >
              {/* Header Icon */}
              <div className="flex items-center flex-wrap gap-4">
        ...
        {showSaveModal && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              exit={{ scale: 0.95, opacity: 0, y: 15 }}
              transition={{ type: "spring", duration: 0.4, bounce: 0.15 }}
              className="relative w-full max-w-lg bg-white rounded-[2.5rem] border border-premium-gold/20 shadow-3xl overflow-hidden p-4 md:p-4 md:p-8 z-10 space-y-6"
            >
              {/* Header Icon */}
              <div className="flex items-center flex-wrap gap-4">
