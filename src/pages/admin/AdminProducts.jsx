    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
           <button onClick={() => { resetForm(); setShowForm(true); }} className="px-4 sm:px-4 sm:px-6 py-3 bg-charcoal text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-premium-gold hover:text-charcoal transition-all flex items-center gap-2 shadow-xl shadow-charcoal/10">
      ...
      <div className="bg-indigo-50 border border-indigo-100 p-4 sm:p-4 sm:p-6 rounded-[2rem] flex items-start gap-4">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex gap-2">
          <select 
            className="bg-white border border-border-light rounded-2xl px-4 sm:px-4 sm:px-6 py-4 text-xs font-black uppercase tracking-widest text-charcoal outline-none focus:ring-2 focus:ring-premium-gold/20 shadow-sm"
      ...
      <div className="bg-white rounded-[2.5rem] border border-border-light overflow-hidden shadow-sm">
          ...
          <table className="w-full min-w-[700px] text-left">
            <thead>
              <tr className="bg-light-bg/50 border-b border-border-light">
                ...
                <th className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 text-[10px] font-black text-text-muted uppercase tracking-widest">Market Class</th>
                <th className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 text-[10px] font-black text-text-muted uppercase tracking-widest">Product Profile</th>
                <th className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 text-[10px] font-black text-text-muted uppercase tracking-widest">Variant Depth (Size/Color/Stock)</th>
                <th className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 text-[10px] font-black text-text-muted uppercase tracking-widest">Global Status</th>
                <th className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 text-[10px] font-black text-text-muted uppercase tracking-widest text-right">Settings</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-border-light/40">
              {isLoading ? (
                ...
                <tr key={p._id} className="hover:bg-light-bg/20 transition-all group">
                  ...
                  <td className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 text-right">
        ...
        {pagination && pagination.pages > 1 && (
          <div className="px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 border-t border-border-light flex items-center justify-between gap-4 bg-light-bg/10">
      ...
      <AnimatePresence>
        {showForm && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              <div className="flex-none p-5 md:p-10 flex items-center justify-between border-b border-border-light bg-light-bg/50">
                <div>
              ...
              <div className="flex-none flex items-center gap-1 px-10 py-5 bg-white border-b border-border-light overflow-x-auto no-scrollbar">
                {[
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 md:px-4 md:px-8 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap ${activeTab === tab.id ? 'bg-charcoal text-white shadow-xl shadow-charcoal/20' : 'text-text-muted hover:bg-light-bg'}`}
                  >
              ...
              <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 md:p-10 custom-scrollbar">
                <div className="max-w-4xl mx-auto">
                  {activeTab === 'basic' && (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
                      
                      {!editingId && (
                        <div className="bg-indigo-50 border border-indigo-100 p-4 md:p-4 md:p-8 rounded-[2.5rem] flex items-center justify-between group">
                           <div className="flex items-center flex-wrap gap-4">
                           ...
                           <div className="flex items-center flex-wrap gap-4">
                              ...
                              <select 
                                ...
                                className="bg-white border-none rounded-xl px-4 sm:px-4 sm:px-6 py-3 text-[10px] font-black uppercase tracking-widest text-indigo-600 shadow-sm outline-none focus:ring-2 focus:ring-indigo-600/20 min-w-[240px]"
                      ...
                      <div className="grid md:grid-cols-2 gap-10">
                        <div className="space-y-6">
                           <div className="space-y-2">
                              ...
                              <input required className="w-full bg-light-bg border-none rounded-2xl px-4 sm:px-4 sm:px-6 py-4 focus:ring-2 focus:ring-premium-gold/30 transition-all font-bold text-sm" value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} placeholder="e.g. Ancel Fit Black Pants" />
                           </div>
                           <div className="grid grid-cols-2 gap-6">
                              <div className="space-y-2">
                                <label className="text-[10px] font-black text-text-muted uppercase tracking-[0.2em] ml-1">Category</label>
                                <select required className="w-full bg-light-bg border-none rounded-2xl px-4 sm:px-4 sm:px-6 py-4 focus:ring-2 focus:ring-premium-gold/30 transition-all font-black text-xs uppercase" value={formData.category} onChange={e => setFormData({...formData, category: e.target.value})}>
                              ...
                              <div className="space-y-2">
                                ...
                                <input className="w-full bg-light-bg border-none rounded-2xl px-4 sm:px-4 sm:px-6 py-4 focus:ring-2 focus:ring-premium-gold/30 transition-all font-black text-xs uppercase" value={formData.sku} onChange={e => setFormData({...formData, sku: e.target.value.toUpperCase()})} placeholder="SKU-XXXX" />
                              </div>
                           </div>
                           <div className="grid grid-cols-2 gap-6">
                              <div className="space-y-2">
                                <label className="text-[10px] font-black text-text-muted uppercase tracking-[0.2em] ml-1">Retail Price (₹)</label>
                                <input type="number" required className="w-full bg-light-bg border-none rounded-2xl px-4 sm:px-4 sm:px-6 py-4 focus:ring-2 focus:ring-premium-gold/30 transition-all font-black text-sm" value={formData.sellingPrice} onChange={e => setFormData({...formData, sellingPrice: e.target.value})} placeholder="0.00" />
                              </div>
                              <div className="space-y-2">
                                <label className="text-[10px] font-black text-text-muted uppercase tracking-[0.2em] ml-1">Discount %</label>
                                <input type="number" className="w-full bg-light-bg border-none rounded-2xl px-4 sm:px-4 sm:px-6 py-4 focus:ring-2 focus:ring-premium-gold/30 transition-all font-black text-sm" value={formData.discountPercentage} onChange={e => setFormData({...formData, discountPercentage: e.target.value})} placeholder="0" />
                              </div>
                           </div>
                        </div>
                        <div className="space-y-2">
                           <label className="text-[10px] font-black text-text-muted uppercase tracking-[0.2em] ml-1">Product Narrative (Description)</label>
                           <textarea rows="9" className="w-full bg-light-bg border-none rounded-[2rem] px-4 sm:px-4 sm:px-6 py-4 sm:py-4 sm:py-6 focus:ring-2 focus:ring-premium-gold/30 transition-all font-medium text-sm resize-none" value={formData.description} onChange={e => setFormData({...formData, description: e.target.value})} placeholder="Write an engaging story for this product..." />
                        </div>
                      </div>

                      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 p-4 md:p-4 md:p-8 bg-light-bg/50 rounded-[2.5rem] border border-border-light">
                        {[
                          ...
                          <div className="flex flex-col max-w-lg mx-auto gap-4">
                            <div className="flex gap-2">
                              <input 
                                ...
                                className="flex-1 bg-white shadow-xl shadow-black/5 rounded-2xl px-4 sm:px-4 sm:px-6 py-4 outline-none border border-border-light focus:border-premium-gold transition-all text-sm font-bold" 
                                value={imageUrl} 
                                onChange={e => setImageUrl(e.target.value)} 
                              />
                              <button type="button" onClick={() => { if(imageUrl) { setFormData({...formData, images: [...formData.images, imageUrl]}); setImageUrl(''); } }} className="bg-charcoal text-white px-4 md:px-4 md:px-8 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-premium-gold transition-colors">Add</button>
                            </div>
                            <div className="relative">
              ...
              <div className="flex-none p-5 md:p-10 bg-light-bg/80 backdrop-blur-md border-t border-border-light flex items-center justify-between">
...
function VariantManagement({ productName, category, productId, sellingPrice }) {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
      <div className="bg-light-bg/50 p-4 md:p-4 md:p-8 rounded-[2.5rem] border border-border-light">
      ...
      <div className="space-y-4">
        ...
        {isLoading ? <Loader2 className="animate-spin text-premium-gold" /> : variants?.length === 0 ? (
          <p className="text-xs font-bold text-text-muted italic p-5 md:p-10 bg-light-bg rounded-3xl text-center border border-dashed border-border-light">No sizes or colors defined yet for this product.</p>
        ) : (
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {variants?.map(v => (
              <div key={v._id} className="bg-white p-4 sm:p-4 sm:p-6 rounded-3xl border border-border-light flex flex-col gap-4 shadow-sm hover:shadow-md transition-all relative group">
