    ...
    <div className="min-h-dvh bg-light-bg/30 pb-20">
      ...
      <div className="max-w-7xl mx-auto p-8 space-y-10">
        <form onSubmit={handlePurchaseSubmit} className="space-y-10">
          ...
          <section className="bg-white rounded-[3rem] border border-border-light p-10 shadow-sm space-y-6">
          ...
          <section className="grid md:grid-cols-3 gap-8">
             <div className="md:col-span-2 bg-white rounded-[3rem] border border-border-light p-10 shadow-sm">
             ...
             <div className="bg-charcoal text-white rounded-[3rem] p-10 shadow-2xl flex flex-col justify-between">
                <div>
