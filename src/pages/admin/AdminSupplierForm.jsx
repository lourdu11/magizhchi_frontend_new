...
export default function AdminSupplierForm() {
   ...
   return (
      <div className="min-h-dvh bg-[#F8F9FA] pb-20">
         ...
         {/* Top Navigation */}
         <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-xl border-b border-border-light px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
               ...
               <div className="flex items-center flex-wrap gap-4">
                  <button onClick={handleCancel} className="px-4 sm:px-4 sm:px-6 py-3 text-[10px] font-black uppercase tracking-widest text-text-muted hover:text-charcoal transition-all">
                     Cancel
                  </button>
                  <button 
                     onClick={handleSubmit}
                     disabled={mutation.isPending}
                     className="px-4 md:px-4 md:px-8 py-4 bg-charcoal text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] shadow-xl hover:bg-premium-gold hover:text-charcoal transition-all flex items-center gap-2"
                  >
         ...
         <main className="max-w-5xl mx-auto px-4 md:px-4 md:px-8 mt-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
               
               {/* Left: Info Card */}
               <div className="lg:col-span-1 space-y-6">
                  <div className="bg-white rounded-[3rem] p-5 md:p-10 shadow-sm border border-border-light relative overflow-hidden group">
                     <div className="absolute top-0 right-0 p-4 md:p-4 md:p-8 text-premium-gold/10 group-hover:scale-110 transition-transform">
                  ...
                  <div className="bg-charcoal rounded-[3rem] p-5 md:p-10 text-white shadow-2xl relative overflow-hidden">
               ...
               <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="space-y-6">
                           <div className="space-y-3">
                              ...
                              <input 
                                 ...
                                 className="w-full bg-light-bg/50 border-2 border-transparent focus:border-premium-gold focus:bg-white rounded-[1.5rem] px-4 md:px-4 md:px-8 py-5 font-black text-charcoal transition-all outline-none"
                                 value={formData.name}
                           ...
                           <div className="space-y-3">
                              ...
                              <input 
                                 type="text"
                                 placeholder="33AABBC..."
                                 className="w-full bg-light-bg/50 border-2 border-transparent focus:border-premium-gold focus:bg-white rounded-[1.5rem] px-4 md:px-4 md:px-8 py-5 font-black text-charcoal uppercase tracking-widest transition-all outline-none"
                        ...
                        <div className="space-y-6">
                           ...
                           <div className="space-y-3">
                              ...
                              <textarea 
                                 ...
                                 className="w-full bg-light-bg/50 border-2 border-transparent focus:border-premium-gold focus:bg-white rounded-[2rem] px-4 md:px-4 md:px-8 py-4 sm:py-4 sm:py-6 font-bold text-charcoal transition-all outline-none resize-none"
                  ...
                  <div className="flex items-center justify-between p-5 md:p-10 bg-white border border-border-light rounded-[3rem] shadow-sm">
