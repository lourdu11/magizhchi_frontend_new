                  ...
                  return (
                    ...
                    >
                      <div className="relative aspect-[4/5] overflow-hidden bg-[#F5F5F7] shrink-0">
                        <SafeImage 
                          src={product.images?.[0] || product.thumbnail || product.laptopImage || product.tabletImage || product.mobileImage || product.variants?.[0]?.images?.[0] || product.variants?.[0]?.laptopImage} 
                  ...
                  return (
                    ...
                    >
                      <div className="w-12 h-14 rounded-xl overflow-hidden shrink-0 border border-border-light/50 bg-[#F5F5F7] relative">
                        <SafeImage src={product.images?.[0] || product.thumbnail || product.laptopImage || product.tabletImage || product.mobileImage || product.variants?.[0]?.images?.[0] || product.variants?.[0]?.laptopImage} width={200} quality={70} alt="" className="w-full h-full object-cover group-hover:scale-105 transition-transform" />
