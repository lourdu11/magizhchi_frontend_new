              ...
              <div className="p-4 md:p-8 border-b border-border-light flex items-center justify-between">
                 <div className="flex items-center gap-4">
                    <div className="w-16 h-16 bg-light-bg rounded-2xl overflow-hidden border border-border-light">
                       <SafeImage src={getValidImage(selectedProduct.images?.[0], selectedProduct.thumbnail, selectedProduct.laptopImage, selectedProduct.mobileImage, selectedProduct.variants?.[0]?.images?.[0], selectedProduct.variants?.[0]?.laptopImage)} className="w-full h-full object-cover" />
                    </div>
                    <div>
                        ...
                        <div className="flex items-center gap-4">
                           <div className="w-12 h-12 bg-white rounded-xl overflow-hidden flex items-center justify-center text-xs font-black text-charcoal border border-border-light uppercase shrink-0">
                              {(v.laptopImage || v.images?.[0] || selectedProduct.laptopImage || selectedProduct.thumbnail || selectedProduct.images?.[0]) ? (
                                <SafeImage 
                                  src={getValidImage(v.images?.[0], v.laptopImage, selectedProduct.images?.[0], selectedProduct.thumbnail, selectedProduct.laptopImage, selectedProduct.mobileImage)} 
                                  fallbackSrc={getValidImage(selectedProduct.images?.[0], selectedProduct.thumbnail, selectedProduct.laptopImage)}
