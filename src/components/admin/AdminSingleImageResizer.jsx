            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button 
                  ...
                  className={`py-2 px-2 rounded-lg text-xs font-bold transition-all flex flex-col items-center gap-1 ${resizeMode === 'crop' ? 'bg-premium-gold text-black shadow-lg' : 'bg-black/40 text-gray-400 hover:text-white hover:bg-white/5'}`}
                >
                  <Crop size={16} />
                ...
                <button 
                  ...
                  className={`py-2 px-2 rounded-lg text-xs font-bold transition-all flex flex-col items-center gap-1 ${resizeMode === 'stretch' ? 'bg-premium-gold text-black shadow-lg' : 'bg-black/40 text-gray-400 hover:text-white hover:bg-white/5'}`}
                >
                  <Maximize size={16} />
                  <span>Force Fit</span>
                </button>
              ...
              <p className="text-[10px] text-gray-500 mt-2 leading-relaxed">
                {resizeMode === 'crop' 
                  ? "Preserves the original look by zooming in and cutting off edges." 
                  : "Stretches the entire image to fit the box without cutting anything, but might distort shapes."}
              </p>
            </div>
